...
async function main() {
  ...
  const agent1Profile = await Profile.create({
  ...
  const agent2Profile = await Profile.create({
  ...
  // Team Member Links
  const adminMember = await TeamMember.create({
  ...
  const managerMember = await TeamMember.create({
    organizationId: org._id,
  ...
  const agent1Member = await TeamMember.create({
    organizationId: org._id,
  ...
  const agent2Member = await TeamMember.create({
    organizationId: org._id,
