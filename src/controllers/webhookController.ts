...
import { IntegrationSettings, Lead } from '../models';
...
export class WebhookController {
  ...
  async captureLead(req: Request, res: Response) {
    ...
    const orgId = req.query.orgId as string || req.body.organizationId;
    if (!orgId) {
    ...
    try {
      ...
      const settings = await IntegrationSettings.findOne({ organizationId: orgId });
